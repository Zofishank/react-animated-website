...
const Footer = () => {
  return (
    <div  className="bg_color bg-zinc-900">

<div className='w-full h-screen bg-zinc-900 flex items-center justify-center rounded-tl-3xl rounded-tr-3xl'>
      <div className="eye_opening relative w-1/2 h-[90vh] px-14 py-24 ">
        <h1 className='font-abc w-[6vw] text-[7vw] leading-none tracking-tighter text-bold uppercase'>Eye-opening</h1>
        <div className="logo absolute bottom-[60px] left-[60px]">
      ...
      <div className="presentation w-1/2 h-[90vh]  py-24 ">
      <h1 className='font-abc text-[8vw] leading-none tracking-tighter text-bold uppercase '>presentation</h1>
       <div className="flex justify-between items-center">

       <div className="links flex-col py-10">

<div className="link1">

<p className='font-poppins text-[20px]'>S:</p>
  <div className="links text-[18px] mt-7 underline">
...
<p className='font-poppins text-[20px] mt-6'>L:</p>
<div className="link text-[18px] mt-7 underline ">

<a href="">202-1965 W 4th Ave</a><br/>
<a href="">Vancouver, Canada</a><br/>
<a href="">30 Chukarina St</a><br/>
...
<div className="link3">
  ...
  <p className='font-poppins text-[20px] mt-6'>E:</p>
  <div className="link text-[18px] mt-7 underline">
...
<div className="link4">
 ...
 <p className='font-poppins text-[20px] mr-36'>M:</p>
  <div className="link mt-7">
